...
public class LoginTest extends TestBase {
	...
	/*
	 * @Test(description =
	 * "Verifies with the valid user is able to login into the application", groups
	 ...
	 * user.getPassword()).getUserName(), "Abc def"); }
	 */
	...
	public void loginExcelTest(User user) {
		...
		assertEquals(homePage.goToLoginPage().doLoginWith(user.getEmailAddress(), user.getPassword()).getUserName(), "Abc def");
